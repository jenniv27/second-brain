...
export default function MindRoutineCard({ routine, done, onComplete, onUncomplete }) {
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: '0.68rem', color: 'var(--steel)', margin: 0 }}>
              {routine.time}
              {done && (
                <span style={{ marginLeft: '0.4rem', color: 'var(--rose)', fontStyle: 'italic' }}>
                  · {done === 'fully' ? 'Fully ✦' : done === 'mostly' ? 'Mostly' : 'Showed up'}
                </span>
              )}
            </p>
          </div>
