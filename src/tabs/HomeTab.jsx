  ...
  return (
    <div className="fade-up">
      ...
      <header style={{
        ...
        {/* Decorative footer rule with wings */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
          gap: '0.6rem',
      ...
      <div style={{ padding: '1.25rem 1.25rem 0' }}>
        ...
        <div style={{ marginTop: '1rem' }}>
          {lowEffortOpen ? (
            <LowEffortMode onClose={() => setLowEffortOpen(false)} />
          ) : (
            <button
        ...
        <div className="card card-accent" style={{
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: '0.82rem', fontWeight: 500, color: 'var(--text-dark)', margin: '0 0 0.15rem' }}>
              Budget snapshot
            </p>
            <p style={{ fontSize: '0.75rem', color: 'var(--steel)', margin: 0 }}>
              Coming soon from your Money tab
            </p>
          </div>
          <MicroMotifs count={3} />
        </div>
